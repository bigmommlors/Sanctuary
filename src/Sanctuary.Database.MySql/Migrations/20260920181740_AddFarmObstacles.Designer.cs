...
namespace Sanctuary.Database.MySql.Migrations
{
    ...
    [Migration("20260920181740_AddFarmObstacles")]
    partial class AddFarmObstacles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sanctuary.Database.Entities.DbCropPlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PlotKey")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)")
                        .HasAnnotation("MySql:CharSet", "utf8mb4");

                    b.Property<int?>("SeedDefinitionId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CharacterId", "PlotKey")
                        .IsUnique();

                    b.ToTable("CropPlots");
                });

            modelBuilder.Entity("Sanctuary.Database.Entities.DbFarmObstacle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FarmKey")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)")
                        .HasAnnotation("MySql:CharSet", "utf8mb4");

                    b.Property<string>("ObstacleKey")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)")
                        .HasAnnotation("MySql:CharSet", "utf8mb4");
                    ...
                    b.HasIndex("CharacterId", "FarmKey", "ObstacleKey")
                        .IsUnique();

                    b.ToTable("FarmObstacles");
                });
            ...
            modelBuilder.Entity("Sanctuary.Database.Entities.DbCharacter", b =>
                {
                    b.Navigation("CropPlots");

                    b.Navigation("FarmObstacles");
