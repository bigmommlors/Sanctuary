...
public static class PacketTunneledClientPacketHandler
{
    ...
    public static bool HandlePacket(GatewayConnection connection, Span<byte> data)
    {
        ...
        var handled = opCode switch
        {
            ...
            BaseEncounterPacket.OpCode => BaseEncounterPacketHandler.HandlePacket(connection, reader, 2),
            ...
            BaseFactoryPacket.OpCode => BaseFactoryPacketHandler.HandlePacket(connection, reader),
            _ => false
        };
